...
| <a name="input_business_service_number"></a> [business\_service\_number](#input\_business\_service\_number) | Number of the business services associated to the current subscription. | `string` | n/a | yes |
| <a name="input_managedby"></a> [managedby](#input\_managedby) | Name of the of the organization that managed the resources. | `string` | q.beyond | yes |
