...
| <a name="input_sql"></a> [sql](#input\_sql) | SQL configuration. | <pre>  object({<br/>    create        = bool<br/>    cust          = string<br/>    rg_key        = string<br/>    type          = string<br/>    subnet        = string<br/>    ip_server     = string<br/>    database_name = string<br/>    collation     = string<br/>    sku_name      = string<br/>    max_size_gb   = number<br/>    tags          = map(string)<br/>  })</pre> | n/a | no |
