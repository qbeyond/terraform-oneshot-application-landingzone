...
| <a name="input_create_vm_win"></a> [create\_vm\_win](#input\_create\_vm\_win) | Set to true to create a template for creating a windows vm. | `bool` | `false` | no |
| <a name="input_create_vm_ux"></a> [create\_vm\_ux](#input\_create\_vm\_ux) | Set to true to create a template for creating a linux vm. | `bool` | `false` | no |
