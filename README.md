...
| <a name="input_vm_ux"></a> [vm\_ux](#input\_vm\_ux) | Set the hostname of vm. | <pre>object({<br/>    hostname = string<br/>    version  = string<br/>    public_key_name  = optional(string)<br/>  })</pre> | `{}` | no |
