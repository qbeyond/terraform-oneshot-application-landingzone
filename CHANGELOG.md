...
- Fixed service connection permissions

## [3.4.2] - 2026-03-19

### Fixed

- Fixed locks template again
...
- Changed locks template into resource group scope

## [3.3.1] - 2026-02-18

### Fixed

- Added PAT setting information to the variable description and fix doc readme template to reduce warning in markdown.
...
- Replaced the storage account variable after fixing a configuration error
...
- Changed windows and linux VMs modules version
...
- Fixed some format and code errors

## [3.0.1] - 2025-08-27

### Changed

- terraform.tftpl azurerm version moved to ~> 4.0
